...
public class Program
{
    ...
    public static string ProductName { get; } = "PSU Utils for Civil 3D 2019-2025";

    /// <summary>Set installer title.</summary>
    public static string InstallerTitle { get; } = "PSU Utils for Civil 3D 2019-2025 Installer";

    /// <summary>Set installer output name template.</summary>
    public static string InstallerName { get; } = "PSU-Utils-Civil3D-2019-2025-Win-Installer";
